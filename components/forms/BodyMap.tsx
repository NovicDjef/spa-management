...
const BODY_ZONES_FRONT = [
  ...
  { id: 'bras-gauche', label: 'Bras G', area: { cx: 30, cy: 35, rx: 4, ry: 10 } },
  { id: 'bras-droit', label: 'Bras D', area: { cx: 70, cy: 35, rx: 4, ry: 10 } },
  { id: 'avant-bras-gauche', label: 'Avant-bras G', area: { cx: 25, cy: 50, rx: 3, ry: 10 } },
  { id: 'avant-bras-droit', label: 'Avant-bras D', area: { cx: 75, cy: 50, rx: 3, ry: 10 } },
