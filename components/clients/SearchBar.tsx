      ...
      <div className="flex gap-2 sm:gap-4">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-12 pr-12 py-2 sm:py-3 rounded-xl border-2 border-gray-200 focus:border-spa-rose-400 focus:ring-4 focus:ring-spa-rose-100 transition-all duration-200 outline-none bg-white"
          />
          {searchQuery && (
            <button
        ...
        <button
          ...
          className={`px-4 sm:px-6 py-2 sm:py-3 rounded-xl border-2 transition-all duration-200 flex items-center gap-2 ${
